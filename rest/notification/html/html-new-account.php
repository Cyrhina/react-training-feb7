      ...
      >
        ...
        >
          <div style="text-align: left; margin-bottom: 20px">
            <figure>
              <img
                src="https://www.thefrontline.asia/wp-content/uploads/2020/06/philippine-frontline-ministries-logo.png"
                alt="fca Logo"
                style="width: 80%; display: block; margin: 0 auto"
              />
            </figure>
            <h1 style="text-align: center">FCA Sponsorship Account</h1>
            <p>Hi'. $name . ' </p>
            <p>To get started you need to create a password.</p>
            <a
