...
import { setIsCostumerForgotEmail } from "../../../../store/StoreAction";
import { NavLink, useNavigate } from "react-router-dom";
import SpinnerButton from "../../../../widget/SpinnerButton";
import { devNavUrl } from "../../../../helpers/functions-general";

const CostumerForgotPass = ({ itemEdit }) => {
  ...
  React.useEffect(() => {
    dispatch(setIsCostumerForgotEmail(true));
  }, []);
          ...
          <div className="login__main">
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting, resetForm }) => {
                ...
                fetchData(
                  setLoading,
                  "/admin/fbs_signup/update-customer-forgot-pass.php",
                  values,
                  null,
                  "",
...
export default CostumerForgotPass;
